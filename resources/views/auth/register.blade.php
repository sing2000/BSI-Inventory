          ...
          <div class="row">
            ...
            <div class="col-md-6 form-section">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="s_name" name="s_name" placeholder="Name of your shop" required autofocus>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div>
                  <button class="select-logo" type="button" onclick="document.getElementById('s_logo').click()">Browse</button>
            ...
            <div class="col-md-6 form-section">
              ...
              <div class="form-group">
                  ...
                  <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Owner's name" required autocomplete="name">
                  @error('name')
              ...
              <div class="form-group">
                  ...
                  <select class="form-control" id="system_role" name="system_role" required>
