<div id="popupAddon" class="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center hidden z-20">
    <div class="bg-white rounded-lg shadow-lg max-w-xl w-full max-h-screen overflow-y-auto">
        ...
        <form id="AddonForm" class="p-6">
            @csrf
            <div class="mb-4">
                <label for="addon_name" class="block text-sm font-medium text-gray-900 mb-1">Add-ons Name</label>
            ...
            <div class="mb-6">
                <label for="pro_cat" class="block text-sm font-medium text-gray-900 mb-1">UOM</label>
