        ...
        <form class="p-4 sm:p-6">
            <div class="flex flex-wrap lg:flex-row flex-col justify-center -mx-2 mb-4">
                ...
                <div class="w-full lg:w-1/2 px-2 mb-4 lg:mb-0">
                    ...
                    <input type="file" id="receiptImage" name="receiptImage" class="border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
            </div>
            <div class="flex flex-wrap lg:flex-row flex-col justify-center -mx-2 mb-4">
