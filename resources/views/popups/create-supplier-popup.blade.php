<div id="popupSupplier" class="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center hidden z-20">
    <div class="bg-white rounded-lg shadow-lg max-w-xl w-full max-h-screen overflow-y-auto">
        ...
        <form id="supplierForm" action="{{ route('suppliers.store') }}" method="POST" class="p-6">
            @csrf
            <div class="mb-4">
                <label for="Sup_name" class="block text-lg font-medium text-gray-700 mb-1">Supplier Name</label>
            ...
            <div class="mb-4">
                <label for="Sup_contact" class="block text-lg font-medium text-gray-700 mb-1">Supplier Contact</label>
            ...
            <div class="mb-6">
                <label for="Sup_address" class="block text-lg font-medium text-gray-700 mb-1">Supplier Address</label>
