...
<div id="editSupplierPopup" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
  <form id="editSupplierForm" action="{{ url('suppliers_update/'.$data->Sup_id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg w-1/2">
    @csrf
    @method('PATCH')
    ...
    <div class="p-6">
      <input type="hidden" id="editSupId" name="Sup_id" value="">
      <div class="mb-4">
        <label for="editSupName" class="block text-sm font-medium text-gray-900">Supplier Name</label>
        <input type="text" id="editSupName" name="Sup_name" value="" class="mt-1 p-2 border border-gray-300 rounded-md w-full">
      </div>
      <div class="mb-4">
        <label for="editSupContact" class="block text-sm font-medium text-gray-900">Supplier Contact</label>
        <input type="text" id="editSupContact" name="Sup_contact" value="" class="mt-1 p-2 border border-gray-300 rounded-md w-full">
      </div>
      <div class="mb-4">
        <label for="editSupAddress" class="block text-sm font-medium text-gray-900">Supplier Address</label>
        <input type="text" id="editSupAddress" name="Sup_address" value="" class="mt-1 p-2 border border-gray-300 rounded-md w-full">
      </div>
